# pages.py — ImNextZoneMnra Enterprise Theme
...
<title>ورود · ImNextZoneMnra</title>
...
.orb-1{width:500px;height:500px;background:var(--mnra-blue);top:-200px;left:-100px;opacity:.18}
.orb-2{width:400px;height:400px;background:var(--mnra-purple);bottom:-150px;right:-120px;opacity:.14;animation-delay:-6s}
.orb-3{width:350px;height:350px;background:var(--mnra-red);top:40%;right:30%;opacity:.08;animation-delay:-3s}
...
.particle:nth-child(1){width:3px;height:3px;background:var(--mnra-blue);top:20%;left:15%;animation-duration:14s;opacity:.5}
.particle:nth-child(2){width:2px;height:2px;background:var(--mnra-purple);top:60%;left:25%;animation-duration:18s;animation-delay:-5s;opacity:.4}
.particle:nth-child(3){width:4px;height:4px;background:var(--mnra-red);top:30%;left:70%;animation-duration:16s;animation-delay:-8s;opacity:.35}
.particle:nth-child(4){width:2px;height:2px;background:var(--mnra-blue);top:75%;left:55%;animation-duration:20s;animation-delay:-2s;opacity:.45}
.particle:nth-child(5){width:3px;height:3px;background:var(--mnra-purple);top:10%;left:45%;animation-duration:15s;animation-delay:-11s;opacity:.3}
.particle:nth-child(6){width:2px;height:2px;background:var(--mnra-red);top:85%;left:80%;animation-duration:22s;animation-delay:-7s;opacity:.4}
.particle:nth-child(7){width:3px;height:3px;background:var(--mnra-blue);top:45%;left:35%;animation-duration:17s;animation-delay:-4s;opacity:.35}
.particle:nth-child(8){width:2px;height:2px;background:var(--mnra-purple);top:55%;left:65%;animation-duration:19s;animation-delay:-9s;opacity:.3}
...
/* Mnra Logo */
.mnra-logo{display:flex;align-items:center;justify-content:center;margin-bottom:28px;position:relative;z-index:1}
.mnra-svg{width:80px;height:80px;filter:drop-shadow(0 4px 12px rgba(43,127,255,.3))}
.mnra-body{fill:url(#mnra-body-grad)}
.mnra-leg{fill:none;stroke:url(#mnra-leg-grad);stroke-width:3;stroke-linecap:round;animation:legPulse 2s ease-in-out infinite}
.mnra-leg:nth-child(even){animation-delay:-1s}
...
.login-title .gradient-text{background:linear-gradient(90deg,var(--mnra-blue),var(--mnra-purple),var(--mnra-red));-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
...
.field-label i{font-size:13px;color:var(--mnra-purple)}
...
.input-wrap input:focus{border-color:var(--mnra-blue);background:rgba(255,255,255,.9);box-shadow:0 0 0 4px rgba(43,127,255,.1)}
...
input:focus ~ .input-icon{color:var(--mnra-blue)}
...
.eye-toggle:hover{color:var(--mnra-purple);background:rgba(123,97,255,.08)}
/* Error */
.error-msg{display:none;align-items:center;gap:8px;background:rgba(255,35,82,.08);border:1px solid rgba(255,35,82,.2);border-radius:var(--radius-sm);padding:11px 14px;margin-bottom:18px;color:var(--mnra-danger);font-size:12px;position:relative;z-index:1}
...
.hint-value{font-family:'Inter',monospace;font-size:14px;font-weight:700;color:var(--mnra-blue);background:rgba(43,127,255,.1);border:1px solid rgba(43,127,255,.2);padding:4px 14px;border-radius:10px;cursor:pointer;transition:all .2s ease;letter-spacing:.06em}
...
.login-btn::before{content:'';position:absolute;inset:0;background:linear-gradient(90deg,var(--mnra-blue),var(--mnra-purple),var(--mnra-red));transition:opacity .3s}
.login-btn::after{content:'';position:absolute;inset:0;background:linear-gradient(90deg,var(--mnra-red),var(--mnra-purple),var(--mnra-blue));opacity:0;transition:opacity .3s}
...
.login-footer .dot{width:5px;height:5px;border-radius:50%;background:var(--mnra-purple);display:inline-block;margin:0 6px}
/* Responsive */
@media(max-width:480px){
  .login-card{padding:32px 24px 30px}
  .login-title{font-size:24px}
  .mnra-svg{width:64px;height:64px}
}
</style>
</head>
...
<div class="login-wrap">
  <div class="login-card">
    <div class="mnra-logo">
      <svg class="mnra-svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="mnra-body-grad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" style="stop-color:#DC2626"/>
            <stop offset="50%" style="stop-color:#1F2937"/>
            <stop offset="100%" style="stop-color:#EF4444"/>
          </linearGradient>
          <linearGradient id="mnra-leg-grad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" style="stop-color:#DC2626"/>
            <stop offset="100%" style="stop-color:#1F2937"/>
          </linearGradient>
        </defs>
        <!-- Hexagon mark -->
        <polygon class="mnra-body" points="50,6 88,28 88,72 50,94 12,72 12,28"/>
        <polygon points="50,24 71,36.5 71,63.5 50,76 29,63.5 29,36.5" fill="none" stroke="#fff" stroke-width="3" opacity=".9"/>
        <circle cx="50" cy="50" r="6" fill="#fff" opacity=".9"/>
      </svg>
    </div>
    <div class="login-title">
      <span class="gradient-text">IMNEXTZONEMNRA</span>
    </div>
    ...
    <div class="login-footer">
      <span class="dot"></span>
      ImNextZone Gateway · ImNextZoneMnra
      <span class="dot"></span>
    </div>
  </div>
</div>
...
(function(){
  ...
  var saved=localStorage.getItem('mnra-theme')||'light';
...
<head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>ImNextZoneMnra · داشبورد</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Vazirmatn:wght@400;500;600;700;800&family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet">
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@tabler/icons-webfont@3.19.0/dist/tabler-icons.min.css">
...
/* ============ CSS VARIABLES ============ */
:root{
  --mnra-blue:#DC2626;--mnra-purple:#1F2937;--mnra-red:#EF4444;
  --success:#16A34A;--warning:#F59E0B;--danger:#DC2626;
  --text-primary:#0F172A;--text-secondary:#475569;
  --bg:#F8FAFC;--surface:#FFFFFF;--surface-glass:rgba(255,255,255,.75);
  --border:rgba(226,232,240,.8);--border-solid:#E2E8F0;
  --gradient:linear-gradient(90deg,#DC2626,#1F2937,#EF4444);
  --gradient-purple:linear-gradient(135deg,#1F2937,#DC2626);
  --gradient-blue:linear-gradient(135deg,#DC2626,#F87171);
...
[data-theme="dark"]{
  ...
  --bg:#050505;--surface:rgba(15,23,42,.9);--surface-glass:rgba(15,23,42,.7);
...
.nav-item.active{background:linear-gradient(135deg,rgba(123,97,255,.1),rgba(43,127,255,.08));color:var(--mnra-purple);border-right-color:var(--mnra-purple);font-weight:700}
.nav-item.active i{color:var(--mnra-purple)}
.nav-badge{margin-right:auto;background:rgba(43,127,255,.12);color:var(--mnra-blue);font-size:9px;padding:2px 7px;border-radius:20px;font-weight:700}
...
.logout-btn{display:flex;align-items:center;justify-content:center;gap:7px;width:100%;padding:9px;border:none;border-radius:var(--radius-sm);background:rgba(255,35,82,.06);color:var(--mnra-red);font-family:inherit;font-size:11.5px;font-weight:600;cursor:pointer;transition:all .2s;margin-top:6px;border:1px solid rgba(255,35,82,.1)}
...
.topbar-title i{color:var(--mnra-blue);font-size:21px}
...
.bell-btn:hover{background:rgba(43,127,255,.12);color:var(--mnra-blue)}
.bell-btn::after{content:'';position:absolute;top:8px;left:8px;width:7px;height:7px;border-radius:50%;background:var(--mnra-red);border:2px solid var(--surface)}
...
.btn-ghost{background:rgba(43,127,255,.06);color:var(--mnra-blue);border:1px solid rgba(43,127,255,.15)}
.btn-ghost:hover{background:rgba(43,127,255,.12)}
.btn-danger{background:rgba(255,35,82,.06);color:var(--mnra-red);border:1px solid rgba(255,35,82,.15)}
...
.btn-purple{background:rgba(123,97,255,.08);color:var(--mnra-purple);border:1px solid rgba(123,97,255,.15)}
...
.badge-blue{background:rgba(43,127,255,.1);color:var(--mnra-blue)}
.badge-green{background:rgba(22,163,74,.1);color:var(--success)}
.badge-red{background:rgba(255,35,82,.1);color:var(--mnra-red)}
.badge-purple{background:rgba(123,97,255,.1);color:var(--mnra-purple)}
.badge-amber{background:rgba(245,158,11,.1);color:var(--warning)}
.dot{width:6px;height:6px;border-radius:50%;flex-shrink:0;display:inline-block}
.dot-green{background:var(--success)}
.dot-red{background:var(--mnra-red)}
.dot-blue{background:var(--mnra-blue)}
...
.stat-icon.blue{background:rgba(43,127,255,.1);color:var(--mnra-blue)}
.stat-icon.purple{background:rgba(123,97,255,.1);color:var(--mnra-purple)}
.stat-icon.green{background:rgba(22,163,74,.1);color:var(--success)}
.stat-icon.red{background:rgba(255,35,82,.1);color:var(--mnra-red)}
...
.server-title i{color:var(--mnra-blue);font-size:17px}
...
.srv-bar-fill.blue{background:linear-gradient(90deg,#DC2626,#F87171)}
.srv-bar-fill.purple{background:linear-gradient(90deg,#1F2937,#4B5563)}
...
.pb-vless{background:rgba(43,127,255,.1);color:var(--mnra-blue)}
.pb-vmess{background:rgba(123,97,255,.1);color:var(--mnra-purple)}
.pb-trojan{background:rgba(255,35,82,.1);color:var(--mnra-red)}
...
.status-dot.expired{color:var(--mnra-red)}
...
.exp-bad{background:rgba(255,35,82,.1);color:var(--mnra-red)}
...
.modal-title i{color:var(--mnra-purple);font-size:18px}
...
.modal-close:hover{background:rgba(255,35,82,.1);color:var(--mnra-red);border-color:rgba(255,35,82,.2)}
...
.form-field label i{color:var(--mnra-purple);font-size:13px}
...
.form-input:focus{border-color:var(--mnra-blue);box-shadow:0 0 0 3px rgba(43,127,255,.1)}
...
.form-select:focus{border-color:var(--mnra-blue)}
...
.cfg-code{background:rgba(15,23,42,.06);border:1px solid var(--border);border-radius:var(--radius-sm);padding:11px 13px;font-family:'Inter',monospace;font-size:10px;color:var(--mnra-blue);word-break:break-all;line-height:1.7;max-height:80px;overflow-y:auto;margin-bottom:10px}
[data-theme="dark"] .cfg-code{background:rgba(0,0,0,.2);color:#F87171}
...
.log-icon-s.info{background:rgba(43,127,255,.1);color:var(--mnra-blue)}
...
.log-icon-s.err{background:rgba(255,35,82,.1);color:var(--mnra-red)}
...
.toast.err{border-color:rgba(255,35,82,.3);background:rgba(255,35,82,.06);color:var(--mnra-red)}
...
.chart-title i{color:var(--mnra-blue)}
...
<div class="bg-particles">
  <div class="bg-p" style="width:4px;height:4px;background:var(--mnra-blue);top:10%;left:20%;animation-duration:18s"></div>
  <div class="bg-p" style="width:3px;height:3px;background:var(--mnra-purple);top:70%;left:40%;animation-duration:22s;animation-delay:-6s"></div>
  <div class="bg-p" style="width:5px;height:5px;background:var(--mnra-red);top:40%;left:70%;animation-duration:16s;animation-delay:-10s"></div>
  <div class="bg-p" style="width:3px;height:3px;background:var(--mnra-blue);top:80%;left:15%;animation-duration:20s;animation-delay:-3s"></div>
  <div class="bg-p" style="width:4px;height:4px;background:var(--mnra-purple);top:25%;left:55%;animation-duration:19s;animation-delay:-8s"></div>
</div>
...
<div class="mobile-top">
  <div class="mobile-brand">
    <svg width="28" height="28" viewBox="0 0 100 100"><defs><linearGradient id="mg1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#DC2626"/><stop offset="100%" style="stop-color:#1F2937"/></linearGradient></defs><polygon points="50,5 90,27.5 90,72.5 50,95 10,72.5 10,27.5" fill="url(#mg1)"/><polygon points="50,25 72,37.5 72,62.5 50,75 28,62.5 28,37.5" fill="none" stroke="#fff" stroke-width="2.5" opacity=".85"/></svg>
    <span>ImNextZoneMnra</span>
  </div>
...
<aside class="sidebar" id="sidebar">
  <div class="sidebar-logo">
    <svg width="36" height="36" viewBox="0 0 100 100"><defs><linearGradient id="sg1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#DC2626"/><stop offset="50%" style="stop-color:#1F2937"/><stop offset="100%" style="stop-color:#EF4444"/></linearGradient></defs><polygon points="50,4 92,27.5 92,72.5 50,96 8,72.5 8,27.5" fill="url(#sg1)"/><polygon points="50,24 74,37.5 74,62.5 50,76 26,62.5 26,37.5" fill="none" stroke="#fff" stroke-width="2.8" opacity=".85"/></svg>
    <div><div class="sidebar-logo-text">ImNextZoneMnra</div><div class="sidebar-logo-sub">ImNextZone Gateway</div></div>
  </div>
  <div class="sidebar-nav">
    ...
    <div class="nav-item" data-page="logout" style="color:var(--mnra-red)"><i class="ti ti-logout"></i> خروج</div>
  </div>
  ...
  <section class="page" id="page-settings">
    ...
    <div class="table-wrap" style="margin-bottom:18px">
      ...
      <div style="padding:18px 22px">
        ...
        <div class="form-row">
          <div class="form-field">
            <label><i class="ti ti-link"></i> MnraX Path</label>
      ...
      <div style="padding:18px 22px" id="worker-connect-form">
        ...
        <div class="form-row">
          ...
          <div class="form-field">
            ...
            <input class="form-input" id="worker-name" value="imnextzone-proxy" placeholder="imnextzone-proxy" dir="ltr">
          </div>
        </div>
        <div style="margin-top:12px;display:flex;gap:8px">
...
<script>
/* ============ GLOBALS ============ */
var isDark=localStorage.getItem('mnra-theme')==='dark';
...
function toggleTheme(){isDark=!isDark;localStorage.setItem('mnra-theme',isDark?'dark':'light');applyTheme(isDark)}
applyTheme(isDark);
...
function renderUsersTable(links,tableId){
  ...
  tbody.innerHTML=links.map(function(l){
    ...
    var bc=pct>90?'var(--mnra-red)':pct>70?'var(--warning)':'var(--mnra-blue)';
    ...
    if(d.hourly){
      ...
      if(trafficChart){trafficChart.data.labels=labels;trafficChart.data.datasets[0].data=vals;trafficChart.update()}
        ...
        trafficChart=new Chart(ctx,{
          type:'line',data:{labels:labels,datasets:[{data:vals,borderColor:'#DC2626',backgroundColor:grad,fill:true,tension:.4,pointRadius:0,borderWidth:2.5}]},
...
async function loadSettings(){
  try{
    ...
    document.getElementById('set-real-spx').value=real.mnrax||'/';
...
async function saveRealitySettings(){
  try{
    var body={
      ...
      mnrax:document.getElementById('set-real-spx').value.trim(),
    ...
    if(d.connected){
      ...
      if(d.last_sync){
        ...
        ls.innerHTML = '<div style="font-size:13px;color:var(--text-secondary)">زمان: '+syncTime+'</div>' +
          ...
          (syncError ? '<div style="font-size:13px;color:var(--mnra-red);margin-top:4px">خطا: '+esc(syncError)+'</div>' : '');
      }
    }else{
...
async function connectWorker(){
  ...
  var worker_name=document.getElementById('worker-name').value.trim()||'imnextzone-proxy';
...
def get_public_page_html(uuid_key: str) -> str:
    """صفحه پابلیک سابسکریپشن با تم ImNextZoneMnra"""
    return f"""<!DOCTYPE html>
<html lang="fa" dir="rtl">
<head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0">
<title>ImNextZoneMnra · اشتراک</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Vazirmatn:wght@400;500;600;700;800&family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet">
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@tabler/icons-webfont@3.19.0/dist/tabler-icons.min.css">
...
[data-theme="dark"]{{
  --text-primary:#F1F5F9;--text-secondary:#94A3B8;
  --bg:#050505;--surface:rgba(15,23,42,.85);--surface-glass:rgba(15,23,42,.7);
...
.bg-orb:nth-child(1){{width:450px;height:450px;background:var(--mnra-blue);top:-150px;left:-100px}}
.bg-orb:nth-child(2){{width:350px;height:350px;background:var(--mnra-purple);bottom:-100px;right:-80px;animation-delay:-7s}}
...
.theme-toggle:hover{{background:rgba(43,127,255,.1);color:var(--mnra-blue)}}
/* Info card */
...
.section-title i{{color:var(--mnra-blue);font-size:15px}}
...
.cfg-status.no{{background:rgba(255,35,82,.1);color:var(--mnra-red)}}
.cfg-code{{background:rgba(15,23,42,.05);border:1px solid var(--border);border-radius:var(--radius);padding:12px 14px;font-family:'Inter',monospace;font-size:10px;color:var(--mnra-blue);word-break:break-all;line-height:1.7;margin-bottom:10px;max-height:80px;overflow-y:auto}}
[data-theme="dark"] .cfg-code{{background:rgba(0,0,0,.2);color:#F87171}}
...
.btn i{{font-size:13px}}
.btn-p{{background:linear-gradient(90deg,var(--mnra-blue),var(--mnra-purple));color:#fff;box-shadow:0 4px 14px rgba(43,127,255,.25)}}
...
.lock-icon{{width:64px;height:64px;border-radius:18px;background:rgba(43,127,255,.1);border:1px solid rgba(43,127,255,.2);display:flex;align-items:center;justify-content:center;margin:0 auto 18px;font-size:28px;color:var(--mnra-blue)}}
...
.lock-input:focus{{border-color:var(--mnra-blue);box-shadow:0 0 0 4px rgba(43,127,255,.1)}}
...
.lock-err{{color:var(--mnra-red);font-size:11px;margin-bottom:10px;min-height:18px}}
/* Toast */
...
<div class="wrap">
  <div class="top-bar">
    <div class="brand">
      <svg width="38" height="38" viewBox="0 0 100 100"><defs><linearGradient id="bgg" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#DC2626"/><stop offset="50%" style="stop-color:#1F2937"/><stop offset="100%" style="stop-color:#EF4444"/></linearGradient></defs><ellipse cx="50" cy="48" rx="17" ry="20" fill="url(#bgg)"/><ellipse cx="50" cy="26" rx="11" ry="9" fill="url(#bgg)"/><circle cx="46" cy="23" r="2.5" fill="#fff"/><circle cx="54" cy="23" r="2.5" fill="#fff"/><path d="M50,50 L12,16 M50,50 L16,50 M50,50 L12,84 M50,50 L88,16 M50,50 L84,50 M50,50 L88,84" stroke="url(#bgg)" stroke-width="2.2" fill="none" stroke-linecap="round"/></svg>
      <div><div class="brand-name">ImNextZoneMnra</div><div class="brand-sub">ImNextZone Gateway</div></div>
    </div>
  ...
  <div class="footer">ImNextZoneMnra · ImNextZone Gateway</div>
</div>
<script>
var UUID_KEY='{uuid_key}',savedPw='',currentData=null;
var isDark=localStorage.getItem('mnra-pub-theme')==='dark';
...
function toggleTheme(){{isDark=!isDark;localStorage.setItem('mnra-pub-theme',isDark?'dark':'light');applyTheme(isDark)}}
applyTheme(isDark);
...
async function init(){{try{{var d=await loadData();if(d.locked){{renderLock(d.name);return}}renderContent(d)}}catch(e){{document.getElementById('root').innerHTML='<div class="empty"><i class="ti ti-alert-circle" style="color:var(--mnra-red)"></i><p>خطا در بارگذاری</p></div>'}}}}
init();
</script>
</body></html>"""
