# mnra_features.py — New panel features: server info, API key, node management,
...
logger = logging.getLogger("Mnra-Features")
...
def node_region_prefix(server_info: dict) -> str:
    """mnra-{flag}-{username} style naming uses the panel's country flag."""
